...
from modules.carbonates import limestone
...
class GebPyGUI(tk.Frame):
    ...
    def __init__(self, parent):
        ...
        opt_list_0_0 = ["Oxides", "Sulfides", "Carbonates", "Halogenes"]
        ...
        opt_list_rocks = ["Sandstone", "Limestone"]
        SE(parent=self.parent, row_id=15, column_id=0, bg=self.color_bg,
           fg=self.color_fg).create_option_menu(var_opt=var_opt, var_opt_set="Select rock", opt_list=opt_list_rocks,
                                                command=lambda var_opt=var_opt: self.select_opt(var_opt))
    #
    def select_opt(self, var_opt):
        if var_opt == "Sandstone":
            ...
            opt_list_1_1 = ["Sandstone"]
            self.opt_oxide = SE(parent=self.parent, row_id=7, column_id=0, bg=self.color_bg, fg=self.color_fg).create_option_menu(
...
class Rocks:
    ...
    def __init__(self, parent, color_bg, color_fg, rock):
        ...
        self.rock = rock
        #
        SE(parent=self.parent_sandstone, row_id=2, column_id=0, bg=self.color_bg,
           fg=color_fg).create_label(text="Number of samples")
        SE(parent=self.parent_sandstone, row_id=3, column_id=0, bg=self.color_bg,
        ...
        #
        SE(parent=self.parent_sandstone, row_id=5, column_id=0, bg=self.color_bg,
        ...
        SE(parent=self.parent_sandstone, row_id=6, column_id=0, bg=self.color_bg,
    ...
    def create_plot(self, parent, data, row_id, column_id, n_rows, n_columns, xlabel):
        ...
        self.ax_histo.hist(data, bins=15, color="tan", edgecolor="black")
        ...
        self.canvas_histo.get_tk_widget().grid(row=row_id, column=column_id, rowspan=n_rows, columnspan=n_columns,
                                               sticky="nesw")
    #
    def create_scatter_plot(self, parent, data_x, data_y, row_id, column_id, n_rows, n_columns, xlabel, ylabel):
        #
        self.canvas = None
        self.fig = Figure(facecolor=self.color_bg)
        self.ax = self.fig.add_subplot()
        #
        self.ax.scatter(data_x, data_y, color="tan", edgecolor="black")
        self.ax.grid(True)
    ...
    def enter_samples(self, var_entr, event):
        ...
        self.create_plot(parent=self.parent_sandstone, data=self.vS, row_id=0, column_id=8, n_rows=10,
                         n_columns=3, xlabel="Seismic velocity $v_S$ (m/s)")
        self.create_plot(parent=self.parent_sandstone, data=self.bulk_mod, row_id=10, column_id=2, n_rows=5,
                         n_columns=3, xlabel="Bulk modulus $K$ (GPa)")
        self.create_plot(parent=self.parent_sandstone, data=self.shear_mod, row_id=10, column_id=5, n_rows=5,
                         n_columns=3, xlabel="Shear modulus $G$ (GPa)")
        self.create_plot(parent=self.parent_sandstone, data=self.poisson, row_id=10, column_id=8, n_rows=5,
                         n_columns=3, xlabel="Poisson's ratio $\\mu$")
        self.create_plot(parent=self.parent_sandstone, data=self.phi*100, row_id=15, column_id=2, n_rows=5,
                         n_columns=3, xlabel="Porosity $\\phi$ (%)")
        self.create_plot(parent=self.parent_sandstone, data=self.gamma_ray, row_id=15, column_id=5, n_rows=5,
                         n_columns=3, xlabel="Gamma ray GR (API)")
        self.create_plot(parent=self.parent_sandstone, data=self.photoelectricity, row_id=15, column_id=8, n_rows=5,
                         n_columns=3, xlabel="Photoelectricity PE (barns/electron)")
    #
    def change_radiobutton(self, var_rb):
        ...
        if var_rb.get() == 0:
            ...
            self.create_plot(parent=self.parent_sandstone, data=self.shear_mod, row_id=10, column_id=5, n_rows=10,
                             n_columns=3, xlabel="Shear modulus $G$ (GPa)")
            self.create_plot(parent=self.parent_sandstone, data=self.poisson, row_id=10, column_id=8, n_rows=10,
                             n_columns=3, xlabel="Poisson's ratio $\\mu$ (1)")
            self.create_plot(parent=self.parent_sandstone, data=self.phi*100, row_id=20, column_id=2, n_rows=5,
                             n_columns=3, xlabel="Porosity $\\phi$ (%)")
            self.create_plot(parent=self.parent_sandstone, data=self.gamma_ray, row_id=20, column_id=5, n_rows=5,
                             n_columns=3, xlabel="Gamma ray GR (API)")
            ...
            self.create_scatter_plot(parent=self.parent_sandstone, data_x=self.rho_b, data_y=self.vP, row_id=0,
                                     ...
                                     ylabel="Seismic velocity $v_P$ (m/s)")
            self.create_scatter_plot(parent=self.parent_sandstone, data_x=self.rho_b, data_y=self.vS, row_id=0,
                                     ...
                                     ylabel="Seismic velocity $v_S$ (m/s)")
            ...
            self.create_scatter_plot(parent=self.parent_sandstone, data_x=self.rho_b, data_y=self.photoelectricity,
                                     ...
                                     xlabel="Densitiy $\\varrho$ (g/ccm)", ylabel="Photoelectricity PE (barns/electron)")
    #
