...
from gebpy.legacy.modules_archive import minerals, geochemistry, oxides
...
from gebpy.legacy.modules_archive.silicates import Tectosilicates, Phyllosilicates, Inosilicates, Nesosilicates
