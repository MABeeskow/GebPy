...
from gebpy.legacy.modules_archive.chemistry import PeriodicSystem, DataProcessing, OxideCompounds
...
from gebpy.legacy.modules_archive.geochemistry import MineralChemistry, TraceElements
#
# Phosphates
class Phosphates:
